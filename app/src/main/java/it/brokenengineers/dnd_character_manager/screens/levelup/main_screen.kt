...
fun NewMagic() {
    ...
    val magicList = listOf(
        MagicItem("Magic Missile", "A missile of magical energy darts forth from your fingertip and strikes its target, dealing 1d4+1 force damage."),
        MagicItem("Fireball", "A bright streak flashes from your pointing finger to a point you choose within range and then blossoms with a low roar into an explosion of flame."),
        MagicItem("Lightning Bolt", "A stroke of lightning forming a line 100 feet long and 5 feet wide blasts out from you in a direction you choose."),
        MagicItem("Cure Wounds", "A creature you touch regains a number of hit points equal to 1d8 + your spellcasting ability modifier."),
    )
        ...
        ExpandableCard(
            ...
            onSelected = {
                selectedMagics = if (selectedMagics.contains(magic)) {
                    ...
                    Toast.makeText(context, "You can only select 2 magics", Toast.LENGTH_SHORT).show()
                    selectedMagics
                }
